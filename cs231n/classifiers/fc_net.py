...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # out shape: X * W1 + b1 => NxH
        out, cache1 = affine_relu_forward(X, W1, b1)
        
        W2 = self.params['W2']
        b2 = self.params['b2']
        # scores shape: NxH x HxC => NxC
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for hidden_dim in hidden_dims:
            W = np.random.normal(0.0, weight_scale, (D, hidden_dim))
        ...
        W = np.random.normal(0.0, weight_scale, (D, num_classes))
    ...
    def loss(self, X, y=None):
        ...
        for layer in range(1, self.num_layers + 1):
            w_key = f'W{layer}'
            b_key = f'b{layer}'
            weights = self.params[w_key]
            bias = self.params[b_key]
